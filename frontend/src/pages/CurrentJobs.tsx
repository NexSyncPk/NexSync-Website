...
export const CurrentJobs: React.FC = () => {
  ...
  return (
    <section className="py-20 bg-background-ice min-h-screen relative">
      {/* Create Button */}
      <div className="absolute top-16 right-4 z-[50] ml-4">
        <Button
          className="px-6 py-3 bg-primary-blue hover:bg-primary-blue/90 text-white font-medium rounded-lg shadow-lg"
          onClick={() => {
            setIsFormOpen(true);
            setForm(true);
          }}
